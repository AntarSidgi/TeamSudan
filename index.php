...
$ex_list = explode("\n", $file_list);
$admins = array(323823995); //ADMIN LIST
$bot_id = 436010894 ; //BOT ID
...
bot('answerInlineQuery',[
        ...
        'results' => json_encode([[
            ...
            'reply_markup'=>['inline_keyboard'=>[
                [
                ['text'=>'للدخول الى البوت اضغط هنا ♻️','url'=>'https://t.me/AntarApiBot']
                ],
             ]]
        ]])
    ]);
...
[
['text'=>'اضفني الى مجموعتك 🚹➕', 'url'=>"https://telegram.me/AntarApiBot?startgroup="]
],
[
...
[
['text'=>'اضفني الى مجموعتك 🚹➕', 'url'=>"https://telegram.me/AntarApiBot?startgroup=start"]
],
[
...
[
['text'=>"اصدر البوت بتاريخ 📅 2017/5/11 ☘", "callback_data"=>"Antar"]
]
]
])
]);
...
'inline_keyboard'=>[
[
['text'=>"اوامر القفل 🔒", "callback_data"=>"Antar"]
],
[
['text'=>'الروابط', 'callback_data'=>"Antar"],
['text'=>'اقفل', 'callback_data'=>"Antar"]
],
[
['text'=>'التوجيه', 'callback_data'=>"Antar"],
['text'=>'اقفل', 'callback_data'=>"Antar"]
],
[
['text'=>'الملصقات', 'callback_data'=>"Antar"],
['text'=>'اقفل', 'callback_data'=>"Antar"]
],
[
['text'=>'الكلايش', 'callback_data'=>"Antar"],
['text'=>'اقفل', 'callback_data'=>"Antar"]
],
[
['text'=>'الصور', 'callback_data'=>"Antar"],
['text'=>'اقفل', 'callback_data'=>"Antar"]
],
[
['text'=>'الصوتيات', 'callback_data'=>"Antar"],
['text'=>'اقفل', 'callback_data'=>"Antar"]
],
[
['text'=>'الاغاني', 'callback_data'=>"Antar"],
['text'=>'اقفل', 'callback_data'=>"Antar"]
],
[
['text'=>'جهات الاتصال', 'callback_data'=>"Antar"],
['text'=>'اقفل', 'callback_data'=>"Antar"]
],
[
['text'=>'الاشعارات', 'callback_data'=>"Antar"],
['text'=>'اقفل', 'callback_data'=>"Antar"]
],
[
['text'=>'الدردشة', 'callback_data'=>"Antar"],
['text'=>'اقفل', 'callback_data'=>"Antar"]
],
[
...
'inline_keyboard'=>[
[
['text'=>"اوامر الفتح 🔒", "callback_data"=>"Antar"]
],
[
['text'=>'الروابط', 'callback_data'=>"Antar"],
['text'=>'افتح', 'callback_data'=>"Antar"]
],
[
['text'=>'التوجيه', 'callback_data'=>"Antar"],
['text'=>'افتح', 'callback_data'=>"Antar"]
...
'inline_keyboard'=>[
[
['text'=>"الوصف 🔻","callback_data"=>"Antar" ],
['text'=>"الامر 🔻","callback_data"=>"Antar" ]
],
[
['text'=>"لطرد العضو بلرد","callback_data"=>"Antar" ],
['text'=>"طرد","callback_data"=>"Antar" ]
],
[
['text'=>"لكتم عضو","callback_data"=>"Antar" ],
['text'=>"كتم","callback_data"=>"Antar" ]
],
[
['text'=>"لازالة الكتم","callback_data"=>"Antar" ],
['text'=>"الغاء الكتم","callback_data"=>"Antar" ]
],
[
['text'=>"للمغادرة من المجموعة","callback_data"=>"Antar" ],
['text'=>"مغادرة","callback_data"=>"Antar" ]
],
[
['text'=>"لاضهار معلوماتك","callback_data"=>"Antar" ],
['text'=>"معلومات","callback_data"=>"Antar" ]
],
[
['text'=>"بلرد على عضو","callback_data"=>"Antar" ],
['text'=>"معلومات","callback_data"=>"Antar" ]
],
[
['text'=>"لالغاء حضر بلرد","callback_data"=>"Antar" ],
['text'=>'الغاء الحضر', "callback_data"=>"Antar" ]
],
[
['text'=>"لعرض الوقت","callback_data"=>"Antar"],
['text'=>"الوقت", "callback_data"=>"Antar"]
],
[
['text'=>"لعرض التاريخ","callback_data"=>"Antar"],
['text'=>"التاريخ","callback_data"=>"Antar"]
],
[
['text'=>"عدد رسائل المجموعة","callback_data"=>"Antar" ],
['text'=>"عدد الرسائل","callback_data"=>"Antar" ]
],
[
['text'=>"عودة 🔙 ", 'callback_data'=>"help"]
]
